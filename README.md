...
* 类别不是猜的：看**这个材料出现在你的哪个脚本组**（地区特产 / 矿物 / 食材与炼金 / 敌人与魔物）；
...
**想看谁在冷却、还要等多久**：Studio 左侧「🌿 资源冷却」页按类别分卡片列表（还能在游戏里自己采过
之后点一下「记为刚采过」）；命令行也可以 `python -m skills.gather_cooldown`。
